...
public class LadderItem extends AbstractItem {
    ...
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        Component display = Component.translatable("gui.shop.itemshop.buyable.ladder.name");

        Component price = Component.translatable("gui.shop.itemshop.buyable.ladder.price");

        Component tooltip = Component.translatable("gui.shop.itemshop.buyable.ladder.lore.tooltip");
        Component tooltip2 = Component.translatable("gui.shop.itemshop.buyable.ladder.lore.tooltip.2");
