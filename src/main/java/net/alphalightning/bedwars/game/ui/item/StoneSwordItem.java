...
public class StoneSwordItem extends AbstractItem {

    @Override
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        Component display = Component.translatable("gui.shop.itemshop.buyable.stonesword.name");

        Component price = Component.translatable("gui.shop.itemshop.buyable.stonesword.price");
