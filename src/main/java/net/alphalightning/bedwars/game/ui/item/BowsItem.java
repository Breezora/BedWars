...
public class BowsItem extends AbstractTabGuiBoundItem {
    ...
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        ...
        Component display = Component.translatable(gui.getTab() == 5 ?
                "gui.shop.itemshop.bows.name.selected" :
                "gui.shop.itemshop.bows.name"
        );
