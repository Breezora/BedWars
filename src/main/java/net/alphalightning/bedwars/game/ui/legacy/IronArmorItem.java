...
public class IronArmorItem extends AbstractItem {

    @Override
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        Component display = Component.translatable("gui.shop.itemshop.buyable.armor.iron.name");

        Component price = Component.translatable("gui.shop.itemshop.buyable.armor.iron.price");
