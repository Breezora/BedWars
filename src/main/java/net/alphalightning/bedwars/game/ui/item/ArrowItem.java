...
public class ArrowItem extends AbstractItem {
    ...
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        Component display = Component.translatable("gui.shop.itemshop.buyable.arrow.name");

        Component price = Component.translatable("gui.shop.itemshop.buyable.arrow.price");
