...
public class GoldenAppleItem  extends AbstractItem {
    ...
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        Component display = Component.translatable("gui.shop.itemshop.buyable.goldapple.name");

        Component price = Component.translatable("gui.shop.itemshop.buyable.goldapple.price");

        Component lore = Component.translatable("gui.shop.itemshop.buyable.goldapple.lore");
