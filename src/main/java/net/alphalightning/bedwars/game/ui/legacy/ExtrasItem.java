...
public class ExtrasItem extends AbstractTabGuiBoundItem {
    ...
    public @NotNull ItemProvider getItemProvider(@NotNull Player viewer) {
        ...
        Component display = Component.translatable(gui.getTab() == 7 ?
                "gui.shop.itemshop.extras.name.selected" :
                "gui.shop.itemshop.extras.name"
        );
