...
public class MinBuildHeightConfigurationStage extends Stage implements HeightConfiguration {
    ...
    @Override
    public void run() {
        player.sendMessage(Component.translatable("mapsetup.stage.5"));
    }
    ...
    public void onChat(AsyncChatEvent event) {
        ...
        try {
            ...
            player.sendMessage(Component.translatable("mapsetup.stage.5.error.invalid-number"));
        ...
        if (!range.isValidIntValue(buildHeight)) {
            player.sendMessage(Component.translatable("mapsetup.stage.5.error.invalid-range",
