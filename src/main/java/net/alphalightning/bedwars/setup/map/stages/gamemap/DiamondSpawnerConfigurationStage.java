...
public class DiamondSpawnerConfigurationStage extends Stage implements LocationConfiguration {
    ...
    public void onSneak(PlayerToggleSneakEvent event) {
        ...
        this.visualizationManager.registerTask(gameMapSetup, new ValuableSpawnerRenderer(plugin, withOffset).render(new ValuableSpawnerVisualization(plugin, SpawnerType.DIAMOND)));
        this.visualizationManager.registerTask(gameMapSetup, new BlockEdgeRenderer(plugin, withOffset.getBlock()).render(new BlockEdgeVisualization(0x5ef2ff)));
